...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        self.start_question_id = start_question_id #edit
    ...
    def __getitem__(self, index):
        ...
        example["input_problem"] = example.pop(self.prompt_key)
        #edit
        question_id = self.start_question_id + index   #避免训练集、测试集的question_id重复
        # question_id = index  # 关键：将入参index赋值给question_id
        example["question_id"] = question_id  # 将question_id加入example字典，后续会进入batch_dict
